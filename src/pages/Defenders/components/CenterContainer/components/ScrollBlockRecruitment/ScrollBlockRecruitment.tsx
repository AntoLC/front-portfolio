  ...
  return (
    <div className={"ScrollBlockRecruitment-" + global.app_config.CSS_ID + " text-center"}>
      <div className="flex justify-between">
        ...
        <div>
          <span className={"material-icons pr-4 " + arrowLeft} onClick={handleClickBack}>
            arrow_back
          </span>
          <span className={"material-icons text-white pl-4 " + arrowRight} onClick={handleClickForward}>
            arrow_forward
          </span>
        </div>
      </div>
