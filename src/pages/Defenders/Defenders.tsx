...
export const Defenders = () => {
    return (
        <RecoilRoot>
            <div className={ "Defenders-" + global.app_config.CSS_ID + " px-0 sm:pt-14 sm:pb-16 min-h-screen bg-gray-bg flex flex-wrap content-center justify-center"}>
                <div className="container-big-main w-full h-full sm:w-11/12 sm:h-4/5 rounded-3xl relative">
                    ...
                    <div className="block sm:grid container-main relative w-full h-full rounded-3xl">
                        <LeftContainer/>
                        <CenterContainer/>
                        <RightContainer/>
                    </div>
