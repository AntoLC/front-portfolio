    ...
    <div className={"Bottom-" + global.app_config.CSS_ID + " sm:flex justify-evenly m-8 sm:m-0 items-center"}>
      <div className="center-right text-white font-sans max-w-full md:max-w-1/2">
        ...
        <div className="text-sm text-purple-300 my-4 w-auto lg:w-96 pr-5">
          Set up an Ethereum Wallet. The first step in your NFT journey is to create a digital wallet where you'll securely store the crypto currency that is
          used to buy, sell, and crea NFTs.
        </div>
        <div className="mt-8 text-center md:text-left">
          ...
          <button className="button-center-right font-sans w-28 sm:w-32 text-xs sm:text-base md:w-36 lg:w-44 py-4 rounded-3xl ml-1 xl:ml-3">
            Discover more
          </button>
        </div>
      </div>
