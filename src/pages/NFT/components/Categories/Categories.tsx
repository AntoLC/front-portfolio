    ...
    <div className={"Categories-" + global.app_config.CSS_ID + " mt-14 lg:mt-24 text-white"}>
      ...
      <div className="flex justify-around items-center">
        <button
          onClick={slideLeft}
          className={
            (slideL ? "border-white " : "border-gray-600 ") +
            " arrow inline-block transform rotate-180 cursor-pointer border-2 rounded-full border-opacity-100 px-2 py-2 leading-4 "
          }
        >
          ➜
        </button>
        ...
        <button
          className={
            (slideR ? "border-white " : "border-gray-600 ") + " arrow inline-block cursor-pointer border-2 rounded-full border-opacity-100 px-2 py-2 leading-4"
          }
          onClick={slideRight}
        >
          ➜
