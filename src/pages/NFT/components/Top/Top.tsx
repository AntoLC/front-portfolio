...
export const Top = () => {
    return (
        <div className={ "Top-" + global.app_config.CSS_ID + " sm:flex sm:justify-between sm:items-center font-sans text-white " }>
            <div className="user-container rounded-3xl p-4 inline sm:p-2 sm:rounded-none sm:border-none">
            ...
            <div className="menu-container menu-open absolute hidden sm:relative pt-20 sm:pt-0 inset-0 sm:block">
